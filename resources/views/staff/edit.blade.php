...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="box">
            <div class="content">
                <div class="col-md-12">                         
                    <form action="{{ route('staffupdate') }}" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                            <input type="hidden" name="staff_id" value="{{$edit[0]->staff_id}}">
                            <div class="col-md-12 form-group">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input placeholder="First name" class="form-control" id="firstName" name="first_name" type="text" value="{{$edit[0]->first_name}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 form-group">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input placeholder="Middle name" class="form-control" id="middleName" name="middle_name" type="text" value="{{$edit[0]->middle_name}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 form-group">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input placeholder="Last name" class="form-control" id="lastName" name="last_name"  type="text" value="{{$edit[0]->last_name}}">
                                    </div>                           
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 form-group">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input placeholder="Email" class="form-control" id="email" name="email" value="{{$edit[0]->email}}" type="text">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 form-group">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input placeholder="Phone" class="form-control" id="phone" name="phone" value="{{$edit[0]->phone}}" type="text">
                                    </div>
                                </div>
                            </div>
