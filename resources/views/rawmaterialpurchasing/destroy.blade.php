    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" class="text-center">Are you sure you want to delete this rawmaterial?</h3>
                <br />
                <form class="form-horizontal" role="form" action="{{url('rawmaterialpurchasing/destroy')}}" method="post">
                    <div class="form-group">
                        <div class="col-sm-10">
                            {{ csrf_field() }}
                            <input type="hidden" class="form-control" name="rm_id" id="identityDelete" >
                        </div>
                    </div>
