    ...
    <div class="content-wrapper">
        ...
        <div class="col-md-12">
            <a href="{{url('processproduct/create')}}">
                <button class="colortext btn btn-success pull-right">New Process Product</button>
            </a>  
                      ...
                      <tbody>  
                       @foreach ($processProducts as $processProduct) 
                        <tr>
                            ...
                            <td width="80">
                                <a type="button" href="#editProccess"  data-toggle="modal" class="edit-pproduct btn btn-success" data-id="{{$processProduct->pp_id}}" data-staff="{{$processProduct->staff_id}}" data-pmname="{{$processProduct->pm_id}}" data-ppname="{{$processProduct->pp_name}}" data-ppqty="{{$processProduct->qty}}" data-ppcost="{{$processProduct->cost}}">Edit</a>
                            </td>
                            <td width="80">
