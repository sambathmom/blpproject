    ...
    function Node(data){
        ...
        this.formatNode = function(opts){
            ...
            if(opts.showControls){
                var buttonsHtml = "<div class='org-add-button' title='Add'>"+opts.newNodeText+"</div><div data-toggle='modal' data-target='#myModal' class='ap' title='assign position' onclick='myap("+data.id+")'><a>Assign</a></div><div title='Delete' class='org-del-button'></div>";
            }
            else{
                buttonsHtml = '';
            }
