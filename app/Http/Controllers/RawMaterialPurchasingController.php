...
class RawMaterialPurchasingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $laborCostId = $laborCost->getLaborCostByGradeAndWorkType($grade, $this->workType);
    ...
    public function update(Request $request)
    {
        ...
        $workedRecord->lc_id = $laborCost->getLaborCostByGradeAndWorkType($grade, $this->workType);
        $workedRecord->wt_id = $this->workType;
